#include "../include/viInspectionControl/postProcessingSequenceDataReady.h"
#include <Poco/UUID.h>
#include <algorithm>
...
void PostProcessingSequenceDataReady::init()
{
    ...
    std::cout << "Post Processing Data Ready block initialization..." << std::endl;
    sleep(3);
    m_SequenceInformation.scanFolders();
    std::cout << "Video folders scanned" << std::endl;
    sleep(3);
    m_ImageFolderMap = m_SequenceInformation.ImageFolderMap();
   // std::cout << "image folder map" << std::endl;
  //  sleep(3);
    m_SampleFolderMap = m_SequenceInformation.SampleFolderMap();
  //  std::cout << "sample folder map" << std::endl;
  //  sleep(3);
 ...
 //   std::cout << "sample folder vector"<< std::endl;
  //  sleep(3);
    m_imageAndSampleFolderVector = m_SequenceInformation.imageAndSampleVector();
    std::cout << "Image and Sample cached in internal memory" << std::endl;
    sleep(3);
    fetchDataFromDB();
