...
#include "viInspectionControl/dbNotificationServer.h"

//#include "viInspectionControl/postProcessingTriggerServer.h"
//#include "postProcessingTriggerServer.h"

#include "event/storageUpdate.handler.h"
#include "event/storageUpdate.interface.h"
#include "viInspectionControl/storageUpdateServer.h"
...
//	TDbNotification<EventHandler>		m_dbNotificationHandler;
...
//	PostProcessingController        m_postProcessingController;
 //   PostProcessingTriggerServer     m_postProcessingTrigger;   
	
//	std::unique_ptr<StorageUpdateServer> m_storageServer; 
 //   std::unique_ptr<precitec::interface::TStorageUpdate<precitec::interface::EventHandler>> m_storageHandler;
